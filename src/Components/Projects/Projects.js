...
export default function Projects () {
    ...
    function handleClick ({target}) {
        ...
        if (selectedProject) {
            ...
            //hide close button and set flex wrap back to nowrap
            closeButton();
            ...
            <div className="section-body">
                ...
                <div className="favorite-projects">
                        ...
                        <div className="project" id="google-flash-cards-container" onMouseOver={handleMouseOver}>
                            ...
                            <iframe width="70%" height="300px" src="https://www.youtube.com/embed/xR3WueEZjko" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
